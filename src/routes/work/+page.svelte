...
<!-- Hero area -->
<div id="hero" class="flex items-center text-white bg-[#6facf2] w-full md:h-[450px]" class:pt-24={isMobile} class:pb-4={isMobile} class:py-0={!isMobile}>
  <div class="container-inner flex flex-col sm:flex-row justify-left items-center py-8 mx-auto">
    ...
    <div class="mt-8 sm:mt-0">
      <img src="/img/rocket-in-clouds.svg" width="275" alt="rocket taking off through the clouds" class="mx-auto sm:mx-0 drop-shadow-xl">
    </div>
  </div>
</div>
...
<div class="container-inner flex flex-col md:flex-row mx-auto py-8 bg-stone-100">
  <div class="basis-1/3 flex justify-center items-center pb-6 md:pb-0">
    <a href="https://flexio.natewilliams.dev/" target="_blank">
      <img src="/img/flexio-logo.png" alt="Flex.io logo" class="w-4/5 md:w-full mx-auto">
    </a>
  </div>
  <div class="basis-2/3">
    <div class="space-y-2">
...
<div class="container-inner flex flex-col md:flex-row mx-2 md:mx-auto py-8 md:py-12">
  {#if !isMobile}
    <div class="basis-1/2 space-y-6 text-center mx-4">
      <a href="https://flexio.natewilliams.dev/" target="_blank">
        <img src="/img/flexio-work-01.png" alt="Flex.io website (archive)" class="w-4/5 mx-auto border border-gray-300 shadow-lg hover:scale-105">
      </a>
      <div class="text-sm pb-12">Flex.io website (archive)</div>
      <a href="https://youtu.be/y9PYtsVnpHk" target="_blank">
        <img src="/img/flexio-work-02.png" alt="Flex.io product demo video" class="w-4/5 mx-auto border border-gray-300 shadow-lg hover:scale-105">
      </a>
  ...
  {#if isMobile}
    <div class="basis-1/2 space-y-6 text-center mx-4">
      <a href="https://flexio.natewilliams.dev/" target="_blank">
        <img src="/img/flexio-work-01.png" alt="Flex.io website (archive)" class="w-5/6 mx-auto border border-gray-300 shadow-lg hover:scale-105">
      </a>
      <div class="text-sm pb-10">Flex.io website (archive)</div>
      <a href="https://youtu.be/y9PYtsVnpHk" target="_blank">
        <img src="/img/flexio-work-02.png" alt="Flex.io product demo video" class="w-5/6 mx-auto border border-gray-300 shadow-lg hover:scale-105">
      </a>
...
<div id="goldprairie" class="container-inner flex flex-col md:flex-row mx-auto py-8 bg-stone-100">
  <div class="basis-1/3 flex justify-center items-center pb-6 md:pb-0">
    <a href="https://goldprairie.natewilliams.dev/" target="_blank">
      <img src="/img/gp-logo.png" alt="Gold Prairie logo" class="w-3/5 md:w-3/4 mx-auto">
    </a>
  </div>
  <div class="basis-2/3">
    <div class="space-y-2">
...
<div class="container-inner flex flex-col md:flex-row mx-2 md:mx-auto py-8 md:py-12">
  {#if !isMobile}
    <div class="basis-1/2 space-y-6 text-center mx-4">
      <a href="https://goldprairie.natewilliams.dev/" target="_blank">
        <img src="/img/gp-work-01.png" alt="Gold Prairie home page (archive)" class="w-4/5 mx-auto border border-gray-300 shadow-lg hover:scale-105">
      </a>
      ...
      <a href="https://www.crunchbase.com/organization/gold-prairie" target="_blank">
        <img src="/img/gp-work-02.png" alt="Gold Prairie company profile on Crunchbase" class="w-4/5 mx-auto border border-gray-300 shadow-lg hover:scale-105">
      </a>
  ...
  {#if isMobile}
    <div class="basis-1/2 space-y-6 text-center mx-4">
      <a href="https://goldprairie.natewilliams.dev/" target="_blank">
        <img src="/img/gp-work-01.png" alt="Gold Prairie home page (archive)" class="w-5/6 mx-auto border border-gray-300 shadow-lg hover:scale-105">
      </a>
      <div class="text-sm pb-10">Gold Prairie home page (archive)</div>
      <a href="https://www.crunchbase.com/organization/gold-prairie" target="_blank">
        <img src="/img/gp-work-02.png" alt="Gold Prairie company profile on Crunchbase" class="w-5/6 mx-auto border border-gray-300 shadow-lg hover:scale-105">
      </a>
...
<div id="kirix" class="container-inner flex flex-col md:flex-row mx-auto py-8 bg-stone-100">
  <div class="basis-1/3 flex justify-center items-center pb-6 md:pb-0">
    <a href="https://www.kirix.com/" target="_blank">
      <img src="/img/kirix-logo.png" alt="Kirix logo" class="w-3/5 md:w-3/4 mx-auto">
    </a>
  </div>
  <div class="basis-2/3">
    <div class="space-y-2">
...
<div class="container-inner flex flex-col md:flex-row mx-2 md:mx-auto py-8 md:py-12">
  {#if !isMobile}
    <div class="basis-1/2 space-y-6 text-center mx-4">
      <a href="https://youtu.be/3pA-W63oJYU" target="_blank">
        <img src="/img/kirix-work-01.png" alt="Kirix product demo video" class="w-4/5 mx-auto border border-gray-300 shadow-lg hover:scale-105">
      </a>
  ...
  {#if isMobile}
    <div class="basis-1/2 space-y-6 text-center mx-4">
      <a href="https://youtu.be/3pA-W63oJYU" target="_blank">
        <img src="/img/kirix-work-01.png" alt="Kirix product demo video" class="w-5/6 mx-auto border border-gray-300 shadow-lg hover:scale-105">
      </a>
      <div class="text-sm pb-10">Product demo video</div>
    </div>
  {/if}
...
<div class="text-white bg-stone-500">
  <div class="container-inner flex flex-col md:flex-row mx-2 md:mx-auto py-8 md:py-16">
    <div class="space-y-8 md:space-y-10 text-center">
      ...
      <button class="cta-btn hover:bg-gray-400 hover:bg-opacity-20 pb-10" onclick={btnSendEmail}>Contact me</button>
