        ...
        <div class="flex flex-col basis-2/5 h-screen px-4 pt-12 pb-20">
            <div class="container-inner flex flex-col grow mx-auto">
                <div class="basis-1/5 pb-8 lg:pb-12">
                    <img
                        src="/img/nate-williams-logo-200.svg"
                ...
                <div class="basis-4/5">
                    ...
                    <div class="prose pb-10">
                        ...
                        and
                        <a
                            href="https://goldprairie.natewilliams.dev"
                    ...
                    <button
                        class="section-btn-lg hover:bg-blue-400 hover:bg-opacity-20 pb-10"
                        onclick={btnSendEmail}>Get in touch</button
                    >
                    <div class="footer-container absolute flex bottom-0 mb-4">
                        <PageFooter />
                    </div>
                </div>
            </div>
        ...
        <div class="container-inner mx-auto py-8">
            <div>
                ...
                <div class="flex justify-center">
                    <button
                        class="section-btn-sm hover:bg-blue-400 hover:bg-opacity-20 pb-8"
                        onclick={btnSendEmail}>Get in touch</button
                    >
                </div>
            </div>
