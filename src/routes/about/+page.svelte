...
<!-- Hero area -->
<div id="hero" class="flex items-center text-white bg-heroblue md:h-[450px] w-full" class:pt-24={isMobile} class:pb-4={isMobile} class:py-0={!isMobile}>
  <div class="container-inner flex flex-col sm:flex-row justify-left items-center py-8 mx-auto">
    ...
    <div class="mt-8 sm:mt-0">
      <img src="/img/trekking-in-mountains.svg" width="275" alt="trekking in the mountains" class="mx-auto sm:mx-0 drop-shadow-xl">
    </div>
  </div>
</div>
...
<div class="container-inner flex flex-col md:flex-row mx-2 md:mx-auto py-12">
  <div class="prose max-w-none space-y-4 my-4">
    ...
    <ul class="space-y-2 pl-8 md:pl-16">
      <li><a href="/work#flexio">Flex.io</a> was about getting data from the cloud into spreadsheets simply by typing a formula</li>
      <li><a href="/work#goldprairie">Gold Prairie</a> pinpointed payment errors by analyzing large volumes of corporate financial data</li>
      <li><a href="/work#kirix">Kirix</a> was a productivity application for data preparation and ad hoc data analysis</li>
    </ul>
  </div>
</div>
