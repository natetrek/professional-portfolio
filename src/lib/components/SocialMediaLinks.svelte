<script>
  let { isHome = $bindable(false) } = $props();
</script>
    ...
    <ul class="flex items-center space-x-8">
      <li>
        <a href="https://github.com/natetrek" target="_blank">
          <svg width="28" height="28" viewBox="0 0 20 19" class={isHome ? 'fill-gray-400 hover:fill-textblue' : 'fill-white hover:fill-gray-400'} xmlns="http://www.w3.org/2000/svg">
      ...
      <li>
        <a href="https://www.linkedin.com/in/nate-williams-4786861/" target="_blank">
          <svg width="27" height="26" viewBox="0 0 24 24" class={isHome ? 'fill-gray-400 hover:fill-textblue' : 'fill-white hover:fill-gray-400'} xmlns="http://www.w3.org/2000/svg">
            <path d="M19,0H5A5,5,0,0,0,0,5V19a5,5,0,0,0,5,5H19a5,5,0,0,0,5-5V5A5,5,0,0,0,19,0ZM8,19H5V8H8ZM6.5,6.73A1.77,1.77,0,1,1,8.25,5,1.75,1.75,0,0,1,6.5,6.73ZM20,19H17V13.4c0-3.37-4-3.12-4,0V19H10V8h3V9.77c1.4-2.59,7-2.78,7,2.47Z" fill-rule="nonzero"/>
          </svg>
        </a>
      </li>
      <li>
        <a href="mailto:nate@natewilliams.dev">
          <svg width="40" height="19" viewBox="0 0 30 20" class={isHome ? 'fill-gray-400 hover:fill-textblue' : 'fill-white hover:fill-gray-400'} xmlns="http://www.w3.org/2000/svg">
