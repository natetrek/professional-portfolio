...
<div>
    <div class="mx-auto flex flex-row items-center justify-between">
        <ul class="flex items-center space-x-8">
            <li>
                <a
                    href="https://github.com/natetrek"
                    target="_blank"
                    rel="noopener noreferrer"
                    aria-label="Nate Williams on GitHub (opens in a new tab)"
                >
                    <svg
                        width="28"
                        height="28"
                        viewBox="0 0 20 19"
                        class={isHome
                            ? "fill-gray-400 hover:fill-textblue"
                            : "fill-white hover:fill-gray-400"}
            ...
            <li>
                <a
                    href="https://www.linkedin.com/in/nate-williams-4786861/"
                    target="_blank"
                    rel="noopener noreferrer"
                    aria-label="Nate Williams on LinkedIn (opens in a new tab)"
                >
                    <svg
                        width="27"
                        height="26"
            ...
            <li>
                <a
                    href="mailto:nate@natewilliams.dev"
                    aria-label="Email Nate Williams at nate@natewilliams.dev"
                >
                    <svg
                        width="40"
                        height="19"
